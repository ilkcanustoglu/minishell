...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/16 19:04:00 by iustoglu          #+#    #+#             */
/*   Updated: 2023/01/09 11:16:25 by iustoglu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*fill_nodes(char **args, int i)
{
	...
	cmds[0] = NULL;
	if (check_args2(args) == 0)
		return (ft_free_matrix2(&args));
